-- ============================================================================
-- TapParfum Portaal — COMPLETE DATABASE-INSTALLATIE (alles-in-één, v5)
-- Plak dit VOLLEDIG in Supabase -> SQL Editor -> Run. Veilig om opnieuw te
-- draaien (idempotent). Bevat migraties 001 t/m 012 (nieuw: gevoelige central-namespaces afgeschermd).
-- ============================================================================

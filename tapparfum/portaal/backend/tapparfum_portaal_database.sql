-- ============================================================================
-- TapParfum Portaal — COMPLETE DATABASE-INSTALLATIE (alles-in-één)
-- Plak dit VOLLEDIG in Supabase -> SQL Editor -> Run. Veilig om opnieuw te
-- draaien (idempotent): bestaande tabellen en data blijven staan.
-- Bevat migraties 001 t/m 008 in de juiste volgorde.
-- ============================================================================

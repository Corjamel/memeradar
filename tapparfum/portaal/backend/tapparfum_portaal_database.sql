-- ============================================================================
-- TapParfum Portaal — COMPLETE DATABASE-INSTALLATIE (alles-in-één, v6)
-- Plak dit VOLLEDIG in Supabase -> SQL Editor -> Run. Veilig om opnieuw te
-- draaien (idempotent). Bevat migraties 001 t/m 013 (nieuw: Community — besloten tijdlijn per AM-portefeuille).
-- ============================================================================

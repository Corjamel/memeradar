...
| Fase | Modules |
|------|---------|
| 0 (nu) | Fundering: auth + rollen + rechten (server-afgedwongen) |
| 1 | Tappunten (winkels): lijst, detail, bewerken |
| 2 | Berichten + agenda + documenten |
| 3 | Dashboards per rol, acties, beloningen |
